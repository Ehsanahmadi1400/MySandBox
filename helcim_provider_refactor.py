...
class HelcimCustomerClient(AbstractCustomerClient):
    ...
    @classmethod
    def create_customer(cls, account_id, **kwargs):
        api_kwargs = dict()
        ...
        if kwargs.get('address1', False) and kwargs.get('postal_code', False) \
            ...
            api_kwargs['billingAddress']['postalCode'] = kwargs['postal_code']
            api_kwargs['billingAddress']['province'] = kwargs['state']
            api_kwargs['billingAddress']['country'] = kwargs['country']
    ...
    @classmethod
    def create_account_link(cls, account_id: str, **api_kwargs):
        return {
    ...
    def create_bank_account(
            ...
            country: str = 'Canada',
            currency: str = 'CAD',
            bank_id_number=None,  # required for Canadian users in helcim
            transit_number=None,  # required for Canadian users in helcim
    ...
    @classmethod
    def get_customer_cards(cls, account_id: str, customer_id: str, **api_kwargs):
...
class HelcimMerchantClient(AbstractMerchantClient):
    ...
    @classmethod
    def create_merchant(cls, account_id, **kwargs):
        api_kwargs = dict()
        if not (kwargs.get('first_name', None) or kwargs.get('last_name', None)):
            raise Exception(
                f'{error_logs_prefix} {cls.create_merchant.__qualname__} '
                f'At least one of first_name or last_name must be defined'
            )
        if kwargs.get('first_name', False) and kwargs.get('last_name', False):
            api_kwargs['contactName'] = kwargs['first_name'] + ' ' + kwargs['last_name']
    ...
    @classmethod
    def retrieve_merchant(cls, customer_id):
        pass

    @classmethod
    def update_merchant(cls, customer_id):
        pass

    @classmethod
    def delete_merchant(cls, customer_id):
        pass
...
class HelcimPayment(AbstractPayment):
    ...
    @classmethod
    def get_invoice_by_invoice_number(cls, account_id: str, invoice_number: str,):
        headers = {
            "accept": "application/json",
            "idempotency-key": str(uuid4())[:25],
            "content-type": "application/json",
    ...
    @classmethod
    def get_invoice_by_invoice_id(cls, account_id: str, invoice_id: str,):
        headers = {
            "accept": "application/json",
            "idempotency-key": str(uuid4())[:25],
            "content-type": "application/json",
...
class HelcimTransfer(AbstractTransfer):
    ...
    @classmethod
    def transfer(cls, account_id, helcim_customer_code, amount: float, bank_token: str, currency: str = 'CAD', **api_kwargs):
        url = "https://api.helcim.com/v2/payment/withdraw"
